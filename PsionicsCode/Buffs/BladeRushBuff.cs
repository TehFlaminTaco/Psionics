...
namespace Psionics.Buffs
{
    public class BladeRushBuff
    {
        ...
        private static readonly string DisplayName = "BladeRushBuff.Name".Translate("Blade Rush");
        private static readonly string Description = "BladeRushBuff.Description".Translate("If you're reading this, Hello!");
